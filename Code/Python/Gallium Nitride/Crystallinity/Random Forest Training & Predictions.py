...
Training_Data = pd.DataFrame(Epitaxy, columns=['Substrate Temperature','N2 Pressure', 'Ga Temperature', 'RF', 'Crystal'])

Map_Space = pd.DataFrame(Test_Inputs, columns=['Substrate Temperature', 'N2 Pressure', 'Ga Temperature', 'RF'])

Training_Inputs = Training_Data.loc[:, ['Substrate Temperature','N2 Pressure', 'Ga Temperature', 'RF']]
